...
class TestCDaqProcessor:
        public JEventProcessor,
        public spdlog::extensions::SpdlogMixin<TestCDaqProcessor>   // this automates proper Log initialization
{
public:
    explicit TestCDaqProcessor(JApplication *);
    ~TestCDaqProcessor() override = default;
