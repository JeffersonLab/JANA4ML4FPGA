...
//============================================================================================
GEMHit::GEMHit(Int_t hitID, Int_t apvID, Int_t chNo, Int_t zeroSupCut, TString isPeakOrSum, Int_t nbOfTB, Int_t stopTB, Int_t startTB) {
...
void GEMHit::TimingFindPeakTimeBin() {
  ...
  map <Int_t, Float_t>::const_iterator  max_itr ;
