...
void GemMapping::LoadMapping(const char * mappingCfgFilename) {
  ...
  while (line.ReadLine(filestream)) {
    ...
    if (readoutBoard == "CARTESIAN")  {
      ...
      Float_t sizeX            = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atof();
      Int_t   nbOfConnectorsX  = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();
      Int_t   orientationX     = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();

      TString planeY           = ((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' );
      Float_t sizeY            = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atof();
      Int_t   nbOfConnectorsY  = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();
      Int_t   orientationY     = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();
      SetCartesianStripsReadoutMap(readoutBoard, detectorType, detector, detID, planeX, sizeX, nbOfConnectorsX, orientationX, planeY, sizeY, nbOfConnectorsY, orientationY) ;
          ...
          Float_t size            = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atof();
          Int_t   nbOfConnectors  = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();
          Int_t   orientation     = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();
          ...
          Float_t length           = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atof();
          Float_t outerRadius      = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atof();
          Float_t innerRadius      = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atof();

          TString planeTop           = ((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' );
          Int_t   nbOfConnectorsTop  = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();
          Int_t   orientationTop     = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();

          TString planeBot           = ((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' );
          Int_t   nbOfConnectorsBot  = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();
          Int_t   orientationBot     = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();
          ...
          Float_t padSizeX     = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atof();
          Float_t nbPadX       = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atof();
          Float_t padSizeY     = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atof();
          Float_t nbPadY       = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atof();
          Float_t nbConnectors = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atof();
          ...
          Float_t etaSectorPos  = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atof();
          Float_t etaSectorSize = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atof();
          Float_t nbConnectors  = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atof();
          Int_t orientation     = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();
    ...
    detID++ ;
      ...
      if(s == "APV") {
        Int_t   fecId     = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();
        Int_t   adcCh     = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();
        TString detPlane  = ((TString)((TObjString*)  myiter.Next())->GetString()).Remove(TString::kLeading, ' ' );
        Int_t   apvOrient = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();
        Int_t   apvIndex  = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();
        Int_t   apvheader = (((TString)((TObjString*) myiter.Next())->GetString()).Remove(TString::kLeading, ' ' )).Atoi();
