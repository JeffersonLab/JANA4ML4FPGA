...
PyTorch_service::PyTorch_service(JApplication *app) {
...
std::shared_ptr<spdlog::logger> PyTorch_service::logger(const std::string &name) {
...
spdlog::level::level_enum PyTorch_service::getDefaultLevel() {return spdlog::default_logger()->level();}

std::string PyTorch_service::getDefaultLevelStr() {return spdlog::extensions::LogLevelToString(getDefaultLevel());}
